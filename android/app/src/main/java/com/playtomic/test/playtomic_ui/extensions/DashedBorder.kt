...
//https://gist.githubusercontent.com/DavidIbrahim/236dadbccd99c4fd328e53587df35a21/raw/24fdf4ba4ae37b6c82526d4446942e9294cf08f9/DashedBorder.kt

/**
 * Returns a [Modifier] that adds border with appearance specified with 1dp, [color] and a
 * rectangle
 *
 ...
 */
fun Modifier.dashedBorder(color: Color) =
    dashedBorder(1.dp, SolidColor(color), RectangleShape, 8.dp, 6.dp)
